            ...
            <section className="bg-base-200 text-base-content">
                <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                    <div className="max-w-xl">
                        <h2 className="text-xl font-bold sm:text-4xl ">What makes us special</h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
                        {Array.from({ length: 6 }).map((_, index) => (
                            <div className="flex items-start gap-4" key={index}>
                                <span className="shrink-0 rounded-lg bg-secondary p-4 text-secondary-content">
                                    <svg
                                        className="size-5"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-primary">Lorem, ipsum dolor.</h2>
